...
constexpr U32Enc DIM_ENC{
    {BitsOffset(9, 1), BitsOffset(13, 1), BitsOffset(18, 1), BitsOffset(30, 1)}};
...
void write_frame_header(BitWriter& w) {
    ...
    write_u32(w, U32Enc{{Val(0), Bits(4), BitsOffset(5, 16), BitsOffset(10, 48)}},
              0);         // name len 0
